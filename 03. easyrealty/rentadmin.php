...
<html>
	<head>
		...
		<link href="stylesheet/rentadmin.css" rel="stylesheet" type="text/css" >
...
<?php
					...
					$sql1="SELECT * FROM properties WHERE purpose='rent'  AND status='online' ORDER BY propertyid DESC";
...
<?php
									...
									<button class='danger'><a class='a' href='rentdelete.php?propertyid=". $resp['propertyid']."'> Delete </a></button>
								</div>
							</div>";
						}
