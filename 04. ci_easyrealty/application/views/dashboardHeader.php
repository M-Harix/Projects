		    ...
		    <div class="container-fluid bg-dark px-0 header" id="myHeader">
		        <div class="row gx-0">
		            <div class="col-lg-3 bg-dark d-none d-lg-block">
		                <a href="approval" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
		                    <h1 class="m-0 display-4 text-primary">Dashboard</h1>
		                </a>
		            </div>
		            <div class="col-lg-9">
		                <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
		                    <a href="approval" class="navbar-brand d-block d-lg-none">
		                        <h1 class="m-0 display-4 text-primary">Dashboard</h1>
		                    </a>
		                    ...
		                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
		                        ...
		                        <a href="signin/logout" class="btn btn-primary py-md-1 px-md-3 d-none d-lg-block">Logout</a>
		                    </div>
		                </nav>
		            </div>
		        </div>
