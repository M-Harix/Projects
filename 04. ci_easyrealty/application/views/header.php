		            ...
		            <div class="col-lg-9">
		                <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
		                    ...
		                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
		                        ...
		                        <a href="signin" class="btn btn-primary py-md-1 px-md-3 d-none d-lg-block">Login</a>
		                        <a href="signup" class="btn btn-primary py-md-1 px-md-3 d-none d-lg-block">Join Us</a>
		                    </div>
		                </nav>
		            </div>
		        </div>
