...
<html>
	<head>
		...
		<link href="stylesheet/buyadmin.css" rel="stylesheet" type="text/css" >
...
<?php
					...
					$sql1="SELECT * FROM properties WHERE purpose='forsale' AND status='online' ORDER BY propertyid DESC";
...
<?php
								...
								<button class='danger'><a class='a' href='buydelete.php?propertyid=". $resp['propertyid']."'> Delete </a></button>
							</div>
							</div>";			
						}
