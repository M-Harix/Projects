...
class RentCommercial extends CI_Controller {
	
	public function index()
	{
		$this->load->model('RenttCommercial');
		$rent['fetch'] = $this->RenttCommercial->rent();
		$name['id']= $this->session->userdata('userid');
		
		if($this->session->user_role)
		{
			$this->load->view('dashboardHeader');
		}
		else if($this->session->user_data)
		{
		...
		$this->load->view('rentcommercial', $rent);
