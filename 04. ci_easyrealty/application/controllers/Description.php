...
class Description extends CI_Controller {
	...
	{
		$this->load->model('Fulldescription');
		$description['fetch'] = $this->Fulldescription->description($fdid);
		$this->load->view('Fulldescription', $description);
	}
	public function description($fdid)
	{
		$this->load->model('Fulldescription');
		$description['fetch'] = $this->Fulldescription->description($fdid);
		$description['img'] = $this->Fulldescription->images($fdid);
		$this->load->view('fulldescription', $description);
	}
