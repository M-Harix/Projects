...
class Profile extends CI_Controller {
	...
	{
		$input['userid'] = $this->session->user_data;
		$this->load->model('Profilee');
		$data['fetch'] = $this->Profilee->profile($input['userid']);
	...
	{
		$this->load->model('Profilee');
		//$update['userid']    = $this->session->user_data;
