...
<html>
	<head>
		...
		<link href="stylesheet/landscape.css" rel="stylesheet" type="text/css" >
	</head>
	<body>
    <?php
    if (isset ($_SESSION['username']))
    ...
    ?>
		<div class="front">
			...
			<img class="w3-imagee" src="Images/landscape images/landscape.jpg">
		</div>
		<div class="body">
			<div class="grid">
<?php
		$q="SELECT * FROM arts WHERE type='landscape' ORDER BY id DESC";
