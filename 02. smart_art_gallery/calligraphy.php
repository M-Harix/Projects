...
<html>
	<head>
		...
		<link href="stylesheet/calligraphy.css" rel="stylesheet" type="text/css" >
	</head>
	<body>
    <?php
    if (isset ($_SESSION['username']))
    ...
    ?>
		<div class="front">
			...
			<h1 id="calligraphy">Calligraphy</h1>
			<img class="w3-imagee" src="Images/calligraphy images/calligraphy.jpg">
		</div>
		<div class="body">
...
<?php
		...
		$q="SELECT * FROM arts WHERE type='calligraphy' ORDER BY id DESC";
