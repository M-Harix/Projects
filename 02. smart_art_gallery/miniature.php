...
<html>
	<head>
		...
		<link href="stylesheet/miniature.css" rel="stylesheet" type="text/css" >
	</head>
	<body>
    <?php
    if (isset ($_SESSION['username']))
    ...
    ?>
		<div class="front">
			...
			<h1 id="mini">Miniature</h1>
			<img class="w3-imagee" src="Images/miniature images/miniature.jpg">
		</div>
		<div class="body">
...
<?php
		...
		$q="SELECT * FROM arts WHERE type='miniature' ORDER BY id DESC";
