...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width: 20%;height: -webkit-fill-available;" id="mySidebar">
  ...
  <div class="w3-large w3-text-grey" style="font-weight:bold;">
    ...
    <a onclick="myAccFunc()" href="#" class="w3-button w3-block w3-white w3-left-align w3-bar-item" id="myBtn">
