...
<html>
	<head>
		...
		<link href="stylesheet/realism.css" rel="stylesheet" type="text/css" >
    ...
    ?>
		<div class="front">
			...
			<h1 id="realism">Realism</h1>
			<img class="w3-imagee" src="Images/realism images/realism.jpg">
		</div>
		<div class="body">
			<div class="grid">
<?php

		$q="SELECT * FROM arts WHERE type='realism' ORDER BY id DESC";
