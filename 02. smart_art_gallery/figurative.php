...
<html>
	<head>
		...
		<link href="stylesheet/figurative.css" rel="stylesheet" type="text/css" >
	</head>
	<body>
    <?php
    if (isset ($_SESSION['username']))
    ...
    ?>
		<div class="front">
			...
			<h1 id="figurative">Figurative</h1>
			<img class="w3-imagee" src="Images/figurative images/figurative.jpg">
		</div>
		<div class="body">
			<div class="grid">
<?php

		$q="SELECT * FROM arts WHERE type='figurative' ORDER BY id DESC";
