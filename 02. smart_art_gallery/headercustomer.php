...
<html>
  <head>
    ...
    <link rel="stylesheet" href="stylesheet/headercustomer.css">
   </head>
<body>
  <nav class="header" id="myHeader">
    ...
    -->
      ...
      <div class="dropdownn" style="text-align: initial;">
        <div class="cartt">
          <a href="cart.php"><i class='fas fa-cart-plus' style='font-size:28px;color:white;margin-left: 7px;
          position: absolute;'></i></a>
        </div>
          <img src="Images/logo.png" onclick="myFun()" class="profile-circle dropbtn"/>
          <i class="fa-solid fa-angle-down dropbtn" onclick="myFun()" style="color:white; margin-left: 3%;"></i>
          <div id="myDropdownn" class="dropdownn-content">
            <a class="dropp" href="userprofile.php"><i class="fa fa-user" aria-hidden="true"></i> My Profile</a>
          <!--  
            <a href="#"><i class="fa fa-bars" aria-hidden="true"></i> My Order</a>
          -->
            <a class="dropp" href="member.php"><i class=' fa far fa-handshake'></i>Membership</a>
            <a class="dropp" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Log Out</a>
          </div>
        </div>
    </div>
  </nav>
  <script>
    ...
    function myFun() {
  document.getElementById("myDropdownn").classList.toggle("ushow");
}
